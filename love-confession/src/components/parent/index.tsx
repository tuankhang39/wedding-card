...
const Parent = (props: ParentProps) => {
  ...
  return (
    <div className="grid grid-cols-2 m-auto px-[5vw] my-5">
      <div className="uppercase text-[15px] font-bold" data-aos="fade-right">
        <h4>Nhà gái</h4>
        <p className="capitalize">Ông {girlParent.father}</p>
        <p className="capitalize">Bà {girlParent.mother}</p>
      </div>
      <div className="uppercase text-[15px] font-bold" data-aos="fade-left">
        <h4>Nhà trai</h4>
